...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $type_of_ceremony = $_POST['type'];
    $ceremony_date = $_POST['date'];
    $venue = $_POST['venue'];

    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO ceremony_bookings (type_of_ceremony, ceremony_date, venue) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $type_of_ceremony, $ceremony_date, $venue);
    ...
    if ($stmt->execute()) {
        ...
        <div id='successOverlay' class='full-page-overlay'>
            <div class='success-message'>
                Ceremony booking successfully created!
            </div>
            <div class='revisit-message'>
                Discover more unforgettable experiences at <strong>Eternal Elegance</strong>! 
                <br> Let's create beautiful memories together!
            </div>
...
<script>
    $(document).ready(function() {
        ...
        setTimeout(function() {
            window.location.href = 'ceremony.html'; // Replace with the desired redirect page
